...
new Example().getName()   // выведет hello`}
    ...
    },
    {
        ...
        description:
            <>
                <p>Метод bind в JavaScript используется для жёсткого привязывания контекста (this) к функции. Он создаёт новую функцию, у которой this всегда будет указывать на переданный объект, независимо от того, как и где она будет вызвана.</p>
    ...
    },
    {
        ...
        description:
            <>
                <p>Методы call, apply и bind в JavaScript используются для управления значением this при вызове функций. Они похожи, но есть важные отличия.</p>
                <p>📌 Общие черты:</p>
             <p>   Все три метода:</p>
