...
const questionHtml= [
    {
        title: "1. Что такое замыкания в JS и почему они важны?",
...
function App() {
    ...
    return (
        <>
            <Html questionHtml={questionHtml} toggleArrowHtml={toggleArrowHtml} activeHtmlIndex={activeHtmlIndex}/>
            <Css questionCss={questionCss} toggleArrowCss={toggleArrowCss} activeCssIndex={activeCssIndex}/>
            <Js questionJs={questionJs} toggleArrowJs={toggleArrowJs} activeJsIndex={activeJsIndex}/>
        </>
    )
}
