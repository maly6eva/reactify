...
const questionCss = [
    {
        ...
        description:
            <>
                <p><u><strong>✅ box-sizing: content-box </strong></u> Размер элемента считается только по содержимому
                    (content).
...
const questionJs = [
    ...
    },
    {
        ...
        description:
            <>
                <strong>this</strong> — это ключевое слово в JavaScript, которое указывает на объект, в контексте
...
console.log(this); // window (в браузере)
                ...
                👉 this указывает на глобальный объект — в браузере это <code>window</code>.
                <br/>
...
console.log(this); // undefined
                ...
                👉 this становится <code>undefined</code>, потому что в строгом режиме JavaScript запрещает
                автоматически привязывать глобальный объект.
                <br/>
